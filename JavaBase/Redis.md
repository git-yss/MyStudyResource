## [1.说说什么是Redis?](http://www.susan.net.cn/interview/12-Redis.html#_1-说说什么是redis)

![img](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c3ee0d2dde577711a54f.png)
...
[点击这里👇🏻获取：100万QPS短链系统、复杂的商城微服务系统、智能翻译助手AI Agent、SaaS点餐系统、刷题吧小程序、商城系统、秒杀系统、AI项目、代码生成神器、苏三demo项目、智能天气播报AI Agent、智能代码审查AI Agent等 10 个项目的：项目源代码、开发教程和技术答疑](http://www.susan.net.cn/pay/project.html)

## [2.Redis可以用来干什么？](http://www.susan.net.cn/interview/12-Redis.html#_2-redis可以用来干什么)
...
## [4.Redis为什么快呢？](http://www.susan.net.cn/interview/12-Redis.html#_4-redis为什么快呢)
...
## [5.能说一下I/O多路复用吗？](http://www.susan.net.cn/interview/12-Redis.html#_5-能说一下i-o多路复用吗)
...
## [6. Redis为什么早期选择单线程？](http://www.susan.net.cn/interview/12-Redis.html#_6-redis为什么早期选择单线程)

官方解释：https://redis.io/topics/faq

![官方单线程解释](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c4910d2dde5777129345.png)
...
## [7.Redis6.0使用多线程是怎么回事?](http://www.susan.net.cn/interview/12-Redis.html#_7-redis6-0使用多线程是怎么回事)
...
# [持久化](http://www.susan.net.cn/interview/12-Redis.html#持久化)

## [8.Redis持久化⽅式有哪些？有什么区别？](http://www.susan.net.cn/interview/12-Redis.html#_8-redis持久化方式有哪些-有什么区别)
...
## [9.RDB 和 AOF 各自有什么优缺点？](http://www.susan.net.cn/interview/12-Redis.html#_9-rdb-和-aof-各自有什么优缺点)
...
## [10.RDB和AOF如何选择？](http://www.susan.net.cn/interview/12-Redis.html#_10-rdb和aof如何选择)
...
为了帮助更多的粉丝朋友，找到个好工作，多拿几个offer。苏三最近建一些工作内推群，群里目前已经收集了很多内推岗位，大厂、中厂、小厂、外包都有。欢迎HR、开发、测试、运维和产品加入。 ![img](https://web-1259428203.cos.ap-chengdu.myqcloud.com/20250305093506862.png)

扫描下方微信，备注：网站+所在城市，即可拉你进工作内推群。 ![img](https://web-1259428203.cos.ap-chengdu.myqcloud.com/WX20250509-190407%402x.png)

## [12.Redis 4.0 的混合持久化了解吗？](http://www.susan.net.cn/interview/12-Redis.html#_12-redis-4-0-的混合持久化了解吗)
...
# [高可用](http://www.susan.net.cn/interview/12-Redis.html#高可用)

Redis保证高可用主要有三种方式：主从、哨兵、集群。

## [13.主从复制了解吗？](http://www.susan.net.cn/interview/12-Redis.html#_13-主从复制了解吗)
...
## [14.Redis主从有几种常见的拓扑结构？](http://www.susan.net.cn/interview/12-Redis.html#_14-redis主从有几种常见的拓扑结构)
...
![一主一从结构](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c5000d2dde57771334ba.png)
2.一主多从结构

一主多从结构（又称为星形拓扑结构）使得应用端可以利用多个从节点实现读写分离（见图6-5）。对于读占比较大的场景，可以把读命令发送到从节点来分担主节点压力。
![一主多从结构](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c50b0d2dde577713457e.png)
3.树状主从结构

树状主从结构（又称为树状拓扑结构）使得从节点不但可以复制主节点数据，同时可以作为其他从节点的主节点继续向下层复制。通过引入复制中间层，可以有效降低主节点负载和需要传送给从节点的数据量。
![树状主从结构](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c5150d2dde57771353fa.png)

## [15.Redis的主从复制原理了解吗？](http://www.susan.net.cn/interview/12-Redis.html#_15-redis的主从复制原理了解吗)

Redis主从复制的工作流程大概可以分为如下几步：
![Redis主从复制工作流程](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c5220d2dde57771365fd.png)
...
## [16.说说主从数据同步的方式？](http://www.susan.net.cn/interview/12-Redis.html#_16-说说主从数据同步的方式)
...
全量复制的完整运行流程如下：
![全量复制](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c5390d2dde5777138538.png)
...
## [18.Redis Sentinel（哨兵）了解吗？](http://www.susan.net.cn/interview/12-Redis.html#_18-redis-sentinel-哨兵-了解吗)
...
> [点击这里👇🏻：复杂的微服务系统、商城系统、代码生成工具实战、秒杀系统、常用demo系统、AI项目等等，手把手从0~1，带你开发完整的项目，这里能够获取项目源代码、开发教程、部署文档和问题答疑](http://www.susan.net.cn/pay/project.html)

## [19.Redis Sentinel（哨兵）实现原理知道吗？](http://www.susan.net.cn/interview/12-Redis.html#_19-redis-sentinel-哨兵-实现原理知道吗)
...
# [缓存设计](http://www.susan.net.cn/interview/12-Redis.html#缓存设计)

## [26.什么是缓存击穿、缓存穿透、缓存雪崩？](http://www.susan.net.cn/interview/12-Redis.html#_26-什么是缓存击穿、缓存穿透、缓存雪崩)
...
## [27.能说说布隆过滤器吗？](http://www.susan.net.cn/interview/12-Redis.html#_27-能说说布隆过滤器吗)

布隆过滤器，它是一个连续的数据结构，每个存储位存储都是一个`bit`，即`0`或者`1`, 来标识数据是否存在。

存储数据的时时候，使用K个不同的哈希函数将这个变量映射为bit列表的的K个点，把它们置为1。

![布隆过滤器](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c6a30d2dde5777160a39.png)我们判断缓存key是否存在，同样，K个哈希函数，映射到bit列表上的K个点，判断是不是1：
...
## [28.如何保证缓存和数据库数据的⼀致性？](http://www.susan.net.cn/interview/12-Redis.html#_28-如何保证缓存和数据库数据的一致性)

根据CAP理论，在保证可用性和分区容错性的前提下，无法保证一致性，所以缓存和数据库的绝对一致是不可能实现的，只能尽可能保存缓存和数据库的最终一致性。

#### [选择合适的缓存更新策略](http://www.susan.net.cn/interview/12-Redis.html#选择合适的缓存更新策略)
...
![删除缓存和更新缓存](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c6b00d2dde57771623ef.png)
...
![先更数据库还是先删缓存](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c6bc0d2dde5777163650.png)目前最流行的缓存读写策略cache-aside-pattern就是采用先更数据库，再删缓存的方式。

#### [缓存不一致处理](http://www.susan.net.cn/interview/12-Redis.html#缓存不一致处理)
...
![缓存一致性](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c6cb0d2dde5777164bf2.png)

**消息队列保证key被删除**
可以引入消息队列，把要删除的key或者删除失败的key丢尽消息队列，利用消息队列的重试机制，重试删除对应的key。

![消息队列保证key被删除](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c6d70d2dde57771664fa.png)这种方案看起来不错，缺点是对业务代码有一定的侵入性。

**数据库订阅+消息队列保证key被删除**
可以用一个服务（比如阿里的 canal）去监听数据库的binlog，获取需要操作的数据。

然后用一个公共的服务获取订阅程序传来的信息，进行缓存删除操作。
![数据库订阅+消息队列保证key被删除](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c6e30d2dde5777167e45.png)
...
![延时双删](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c6f00d2dde5777169473.png)
...
# [Redis运维](http://www.susan.net.cn/interview/12-Redis.html#redis运维)

## [34.Redis报内存不足怎么处理？](http://www.susan.net.cn/interview/12-Redis.html#_34-redis报内存不足怎么处理)
...
# [Redis应用](http://www.susan.net.cn/interview/12-Redis.html#redis应用)

## [40.使用Redis 如何实现异步队列？](http://www.susan.net.cn/interview/12-Redis.html#_40-使用redis-如何实现异步队列)
...
![list作为队列](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c7680d2dde5777179049.png)
可以通过让消费者休眠的方式的方式来处理，但是这样又会又消息的延迟问题。

-**使用list作为队列，lpush生产消息，brpop消费消息**

brpop是rpop的阻塞版本，list为空的时候，它会一直阻塞，直到list中有值或者超时。
![list作为队列，brpop](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c7770d2dde577717b579.png)
...
![pub/sub](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c7820d2dde577717d532.png)
...
## [42.Redis 支持事务吗？](http://www.susan.net.cn/interview/12-Redis.html#_42-redis-支持事务吗)
...
![Redis事务](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c7a60d2dde5777181523.png)
...
## [47.Redis 的 SDS 和 C 中字符串相比有什么优势？](http://www.susan.net.cn/interview/12-Redis.html#_47-redis-的-sds-和-c-中字符串相比有什么优势)

C 语言使用了一个长度为 `N+1` 的字符数组来表示长度为 `N` 的字符串，并且字符数组最后一个元素总是 `\0`，这种简单的字符串表示方式 不符合 Redis 对字符串在安全性、效率以及功能方面的要求。

![C语言的字符串](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c8500d2dde57771980ae.png)
...
![Redis sds](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c85a0d2dde5777199309.png)
...
## [48.字典是如何实现的？Rehash 了解吗？](http://www.susan.net.cn/interview/12-Redis.html#_48-字典是如何实现的-rehash-了解吗)
...
![Redis字典结构](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c8660d2dde577719b00d.png)
...
## [50.压缩列表了解吗？](http://www.susan.net.cn/interview/12-Redis.html#_50-压缩列表了解吗)

压缩列表是 Redis **为了节约内存** 而使用的一种数据结构，是由一系列特殊编码的连续内存快组成的顺序型数据结构。

一个压缩列表可以包含任意多个节点（entry），每个节点可以保存一个字节数组或者一个整数值。

![压缩列表组成部分](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c89b0d2dde57771a2ef5.png)压缩列表由这么几部分组成：
...
![压缩列表示例](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c8aa0d2dde57771a4d6a.png)

## [51.快速列表 quicklist 了解吗？](http://www.susan.net.cn/interview/12-Redis.html#_51-快速列表-quicklist-了解吗)
...
![quicklist](https://web-1259428203.cos.ap-chengdu.myqcloud.com/6460c8b70d2dde57771a6c8f.png)

# [其他问题](http://www.susan.net.cn/interview/12-Redis.html#其他问题)

## [52.假如Redis里面有1亿个key，其中有10w个key是以某个固定的已知的前缀开头的，如何将它们全部找出来？](http://www.susan.net.cn/interview/12-Redis.html#_52-假如redis里面有1亿个key-其中有10w个key是以某个固定的已知的前缀开头的-如何将它们全部找出来)
